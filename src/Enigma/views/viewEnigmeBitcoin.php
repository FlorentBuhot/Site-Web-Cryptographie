    ...
    <div class="element_section">
        <div id="cont_eni">
            ...
            <div class="main_box">
                ...
                <br>
                <p id="ennonce"></p>
                <img src="<?= $dir . $image['ASCII'] ?>" alt='Tableau des valuers ASCII' class="ascii">
...
<form method="post" id="formReponse">
    ...
    <input type="hidden" name="enigme" value="bitcoin">
...
<script type="text/javascript" src="<?= $dir . $enigme['bitcoin'] ?>"></script>
