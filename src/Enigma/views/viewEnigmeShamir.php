...
<?php $this->_t = "Le partage de Shamir"; ?>
    ...
    <div class="element_section">
        ...
        <div id="cont_eni">
            ...
            <div class="main_box">
                ...
                <br>
                <br>
                <p>En 1979, le cryptographe israëlien <a href="https://fr.wikipedia.org/wiki/Adi_Shamir">Adi Shamir</a>
                    a inventé une technique élégante pour qu'un nombre
                    secret ne soit accessible que si au moins k personnes collaborent.<br>
                    Cette technique s'appelle le <i>partage de secret</i>.</p>
                <br><br>
                <p>Nous allons illustrer le fonctionnement de cette méthode avec k=3.<br>
                    Il suffit que chacune des personnes impliquées reçoivent les coordonnées(x, y) d'un point du plan,
                    différent pour chacun.<br>
                    Ces points ne sont pas choisis au hasard :<br>
                    ils appartiennent tous à une certaine courbe dont l'équation est de la forme :</p>
                <br>
                <p class="center"><i> y =ax<sup>3</sup> + bx<sup>2</sup> + cx + s</i></p>
                <br><br>
                <p> les paramètres <i>a, b</i> et <i>s</i> ne sont pas donnés et le nombre secret est s, le terme
                    constant de l'équation de cette courbe.</p>
                <br>
                <br>
                <p id="ennonce">Soit Alice, Bobby, Carol et David qui ont respectivement les points :</p>
                <p id="A"></p>
                <p id="B"></p>
                <p id="C"></p>
                <p id="D"></p>
    ...
    <?php if (isset($user)): ?>
        <div class="main_box">
            ...
            <button id='btnIndice' class="btn-ind" type="button" onclick="sendPoints();" form="formReponse">Découvrir un
                nouvel indice<br> (-<span id="points">500</span> points)
            </button>
        </div>
    <?php endif; ?>
...
<div class="zone_valid">
    ...
    <div class="fenetre-suite">
        ...
        <div class="bouton-container">
            ...
            <?php if ((!isset($un) || !isset($deux) || !isset($trois)) && isset($_SESSION['username'])) { ?>
...
<div class="zone_alert">
    ...
    <p>Cela fait plus de 10 minutes que vous êtes bloqué, il est conseillé d'utiliser les indices !</p>
</div>

<form method="post" id="formReponse">
    <input type="hidden" id="sendNiveau" name="niveau">
    <input type="hidden" id="sendClassement" name="time">
    <input type="hidden" name="enigme" value="shamir">
...
<script type="text/javascript" src="<?= $dir . $enigme['shamir'] ?>"></script>
