...
<?php $this->_t = "Les énigmes de Jules"; ?>
    ...
    <div class="element_section">
        ...
        <div id="cont_eni">
            ...
            <div class="main_box">
                ...
                <br>
                <br>
                <p align="justify">Dans cette énigme, vous êtes un professeur. Durant les cours, vous avez vu que les
                    élèves s'échangeaient des mots chiffrés. Vous arrivez à les récupérer, mais ne pouvez pas les
                    comprendre, cependant vous avez réussi à trouver un message non chiffré et vous pensez qu'il peut
                    vous aider à comprendre le reste des messages qu'ils s'envoient.</p>
                <br>
                <p class="center">
                    Soit le message non chiffré que vous avez récupéré:
                </p>

                <div>
                    <div>
                        <h4 class="cadre" id="msgNC">
                            <p class="right" id="dateNC"></p>
                            Aux initiés,
                            <br/>Je me suis rendue compte que quelque chose dans la classe n'allait pas:
                            <br/>Depuis des jours des comportements bizarres sont apparus pendant les récréations.
                            <br/>Nous faisons donc des suppositions sur qui peut être à l'origine de ça.
                            <br/>
                            <br/>post-scriptum : Voyez ce koala fou qui mange des journaux et des photos dans un
                            bungalow.
                            <br/>
                            <p></p>
                        </h4>
...
<form method="post" id="formReponse">
    ...
    <input type="hidden" name="enigme" value="jules">
...
<script type="text/javascript" src="<?= $dir . $enigme['cesar'] ?>"></script>
