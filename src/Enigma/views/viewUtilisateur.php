    ...
    <div class="box">
        ...
        <div class="element">
            ...
            <form method="post" onsubmit="return confirm('Voulez vous changer votre image de profil ?')"
                ...
                <label for="avatar" class="perso">Choississez une image de profil :<br>(Taille maximale : 2Mo , format :
        ...
        <div class="element">
            ...
            <form method="post" onsubmit="return confirm('Voulez vous vraiment modifier votre mot de passe ?')">
                <label for="mdpAtu" class="perso">Saississez votre mot de passe actuel :</label>
                <div>
                    <input type="password" id="mdpAtu" name="txtMdpActuel" required>
                </div>
                <label for="mdp" class="perso">Saississez votre nouveau mot de passe :</label>
                <div>
        ...
        <hr>
        <div class="element" onsubmit="return confirm('Voulez-vous vraimer supprimer votre compte ?');">
            <p>Supprimez votre compte :</p>
            <form method="post">
                <div>
                    <label for="mdp" class="perso">Saississez votre mot de passe :</label>
                    <div>
                        <input type="password" id="mdp" name="txtMdp" required>
                    </div>
