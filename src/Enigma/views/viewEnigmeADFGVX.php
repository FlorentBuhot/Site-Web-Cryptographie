...
<?php $this->_t = "Un chiffrement presque allemand"; ?>
...
<form method="post" id="formReponse">
    ...
    <input type="hidden" name="enigme" value="allemand">
...
<script type="text/javascript" src="<?= $dir . $enigme['ADFGVX'] ?>"></script>
