...
<?php $this->_t = "Chiffrement malléable"; ?>
        ...
        <div id="cont_eni">
            ...
            <div class="rep_box">
                ...
                <form name="reponse">
                    ...
                    <label>
                        <textarea name="box" id="box"></textarea>
                    </label>
...
<form method="post" id="formReponse">
    ...
    <input type="hidden" name="enigme" value="malleable">
...
<script type="text/javascript" src="<?= $dir . $enigme['malleable'] ?>"></script>
